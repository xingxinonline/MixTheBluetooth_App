...
public abstract class RecyclerCommonAdapter<DATA> extends RecyclerView.Adapter<ViewHolder>{
    ...
    private MulitiTypeSupport<DATA> mTypeSupport;
    ...
    public RecyclerCommonAdapter(Context context,List<DATA> data,MulitiTypeSupport<DATA> typeSupport){
        this(context,data,-1);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, final int position) {
        ...
        if(mItemClickListener != null){
            holder.itemView.setOnClickListener(view -> mItemClickListener.onItemClick(position,view));
        }

        if(mItemLongClickListener != null){
            holder.itemView.setOnLongClickListener(view -> mItemLongClickListener.onItemLongClick(position));
        }
    }
